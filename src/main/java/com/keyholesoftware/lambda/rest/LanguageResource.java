...
public class LanguageResource {
    ...
    @RequestMapping(path = "/languages2", method = RequestMethod.GET)
    public List<Language> listLambdaLanguages2() {
        return Arrays.asList(new Language("node2"), new Language("java2"), new Language("python2"));
